...
const ChatbotWidget = () => {
  ...
  return (
    <>
      {/* Proactive popup */}
      {showPopup && !open && (
        <div className="fixed bottom-[8.5rem] right-6 w-72 z-50 animate-slide-up">
          <div className="relative rounded-xl border border-accent/20 bg-card p-4 shadow-2xl">
            ...
            <div className="absolute -bottom-2 right-6 w-4 h-4 rotate-45 border-r border-b border-accent/20 bg-card" />
          </div>
        </div>
      )}
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full gradient-gold flex items-center justify-center glow-gold hover:scale-110 transition-transform shadow-lg ${
