  ...
  return (
    <section className="section-padding bg-secondary/30">
      <div className="max-w-6xl mx-auto" ref={ref}>
        ...
        <h2 data-animate data-delay="100" className="font-serif text-3xl md:text-5xl font-bold text-foreground text-center mb-6">
          AI-Powered Automation That Works{" "}
          <span className="gradient-gold-text">While You Sleep</span>
        </h2>
        <p data-animate data-delay="150" className="text-muted-foreground text-center max-w-2xl mx-auto mb-16 text-lg">
          We build intelligent systems that transform how your business captures, qualifies, and converts leads.
        </p>
        <div className="grid md:grid-cols-3 gap-8">
          {solutions.map((s, i) => (
            <div key={i} data-animate data-delay={200 + i * 150} className="text-center group">
