...
const HeroSection = () => {
  return (
    <section
      ...
      style={{ background: "hsl(218, 58%, 10%)" }}
    >
      ...
      <div
        ...
        style={{ background: "rgba(6,14,26,0.52)", zIndex: 1 }}
      />

      {/* Layer 3 — Hero text */}
      <div
        className="relative max-w-4xl 2xl:max-w-6xl mx-auto text-center px-6 pt-12 md:pt-16 2xl:pt-20"
        style={{ zIndex: 10 }}
      >
        ...
        <p
          className="font-sans text-lg md:text-xl 2xl:text-2xl text-muted-foreground max-w-2xl 2xl:max-w-3xl mx-auto mb-10 2xl:mb-14 leading-relaxed animate-fade-in-slow"
          style={{ animationDelay: "0.3s" }}
        >
          In a digital universe defined by chaos and saturation, Inkanyezi
          Technologies stands as a fixed point of navigation — illuminating the
          future for South African businesses.
        </p>
        <div
          className="flex flex-col sm:flex-row items-center justify-center gap-4 2xl:gap-6 animate-fade-in-slow"
